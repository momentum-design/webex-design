export const data = [{
    ...
    color: '#72DA32',
    color2: '#2D4E19',
    description: `We cannot win our customers’ trust unless security is inherent in every line of code we write, and every solution we design.
    <br><br>So when it comes to a customer’s data, we put their privacy ahead of our own interests. 
    <br><br>Any use of data will be transparent, honest, and always opt-in. It is our fundamental belief that privacy is a basic human right. `
},{
    ...
    <br><br>So we aim extrordinarily high to give customers a solution that’s 10x better than what they have today.`
}];
